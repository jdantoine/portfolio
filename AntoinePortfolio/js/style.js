$(document).ready(function() {
	...
	Backstretch Images
	==============================================*/
	$.backstretch('assets/road.jpg');

	$('body').append('<img class="preload-image" src="assets/dirt-road.jpg" style="display:none;"/>');
	...
	$('#about').waypoint(function(direction){
		...
		if (direction=='down'){
			$.backstretch('assets/dirt-road.jpg');
		}else{
			$.backstretch('assets/road.jpg');
		}
	});
